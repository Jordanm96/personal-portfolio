  ...
  return (
    <div>
      ...
      <p>
        ...
        movies they have watched. Fresh Tomatoes lets the user become a
        movie critic, as they write their own personal opinions on the movie and
        leave it with a rating to help other users decide what to watch next.
      </p>
      <p>
